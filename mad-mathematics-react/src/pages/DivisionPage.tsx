/**
 * DivisionPage - Mad Mathematics
 * Division game page with per-question timer and 4 difficulty levels
 * Ensures num1 = num2 × quotient for integer results
 */
...
import { DIVISION_DIFFICULTIES, createHighscoreKey } from '../types';
import type { Difficulty, Answer, Question } from '../types';

/**
 * Division game page component
 * Implements the full game flow for practicing division
      ...
      <Card className="max-w-md w-full">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-amber-400 mb-2">
            ➗ École de Magie des Divisions ✨
          </h1>
          <p className="text-purple-200">
            Entraîne-toi à diviser comme un magicien !
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <DifficultySelector
            difficulties={DIVISION_DIFFICULTIES}
            onSelect={onStart}
          />
        </div>
